...
void setup() {
  Serial.begin(57600); // baud rates affects the rate of data recieve by the arduino/esp32/esp82 not the control algo
 ...
 // pinMode(14,OUTPUT); //For checking purpose GPIO14 - D5(recheck for esp32)
